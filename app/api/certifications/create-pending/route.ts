...
import { createPendingCertificationAndSelect } from '@/services/skillsProfile.service'
import { z } from 'zod'
...
export async function POST(req: Request) {
  ...
  try {
    ...
    const result = await createPendingCertificationAndSelect(user.id, body.name)
